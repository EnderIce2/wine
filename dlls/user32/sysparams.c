...
#define RGB_ENTRY(name,val,reg) { { get_rgb_entry, set_rgb_entry, init_rgb_entry, COLORS_KEY, reg }, (val) }
    RGB_ENTRY( COLOR_SCROLLBAR, RGB(15, 15, 15), L"Scrollbar" ),
    RGB_ENTRY( COLOR_BACKGROUND, RGB(0, 0, 69), L"Background" ),
    RGB_ENTRY( COLOR_ACTIVECAPTION, RGB(120, 16, 169), L"ActiveTitle" ),
    RGB_ENTRY( COLOR_INACTIVECAPTION, RGB(128, 128, 128), L"InactiveTitle" ),
    RGB_ENTRY( COLOR_MENU, RGB(28, 28, 28), L"Menu" ),
    RGB_ENTRY( COLOR_WINDOW, RGB(15, 15, 15), L"Window" ),
    RGB_ENTRY( COLOR_WINDOWFRAME, RGB(0, 0, 0), L"WindowFrame" ),
    RGB_ENTRY( COLOR_MENUTEXT, RGB(244, 244, 244), L"MenuText" ),
    RGB_ENTRY( COLOR_WINDOWTEXT, RGB(244, 244, 244), L"WindowText" ),
    RGB_ENTRY( COLOR_CAPTIONTEXT, RGB(244, 244, 244), L"TitleText" ),
    RGB_ENTRY( COLOR_ACTIVEBORDER, RGB(28, 28, 28), L"ActiveBorder" ),
    RGB_ENTRY( COLOR_INACTIVEBORDER, RGB(40, 40, 40), L"InactiveBorder" ),
    RGB_ENTRY( COLOR_APPWORKSPACE, RGB(128, 128, 128), L"AppWorkSpace" ),
    RGB_ENTRY( COLOR_HIGHLIGHT, RGB(50, 50, 50), L"Hilight" ),
    RGB_ENTRY( COLOR_HIGHLIGHTTEXT, RGB(244, 244, 244), L"HilightText" ),
    RGB_ENTRY( COLOR_BTNFACE, RGB(30, 30, 30), L"ButtonFace" ),
    RGB_ENTRY( COLOR_BTNSHADOW, RGB(40, 40, 40), L"ButtonShadow" ),
    RGB_ENTRY( COLOR_GRAYTEXT, RGB(150, 150, 150), L"GrayText" ),
    RGB_ENTRY( COLOR_BTNTEXT, RGB(244, 244, 244), L"ButtonText" ),
    RGB_ENTRY( COLOR_INACTIVECAPTIONTEXT, RGB(212, 208, 200), L"InactiveTitleText" ),
    RGB_ENTRY( COLOR_BTNHIGHLIGHT, RGB(75, 75, 75), L"ButtonHilight" ),
    RGB_ENTRY( COLOR_3DDKSHADOW, RGB(64, 64, 64), L"ButtonDkShadow" ),
    RGB_ENTRY( COLOR_3DLIGHT, RGB(10, 10, 10), L"ButtonLight" ),
    RGB_ENTRY( COLOR_INFOTEXT, RGB(244, 244, 244), L"InfoText" ),
    ...
    RGB_ENTRY( COLOR_GRADIENTACTIVECAPTION, RGB(220, 0, 0), L"GradientActiveTitle" ),
    RGB_ENTRY( COLOR_GRADIENTINACTIVECAPTION, RGB(252, 152, 192), L"GradientInactiveTitle" ),
    RGB_ENTRY( COLOR_MENUHILIGHT, RGB(10, 10, 10), L"MenuHilight" ),
    RGB_ENTRY( COLOR_MENUBAR, RGB(36, 36, 36), L"MenuBar" )
#undef RGB_ENTRY
};
