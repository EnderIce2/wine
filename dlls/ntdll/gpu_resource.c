...
WINE_DEFAULT_DEBUG_CHANNEL(gpu_res);
...
int server_get_unix_fd( HANDLE handle, unsigned int wanted_access, int *unix_fd, int *needs_close, enum server_fd_type *type, unsigned int *options )
{
    FIXME("unimplemented\n");
    return 0;
}
